...
function merge(arr, l, m, r) {
  //This is our iterative merge approach... We have two sorted arrays of this point and need to merge them together in order
...
let unsorted = [1, 3, 3, 5, 6, 2, 6, 7, 2, 0]; //10 length
let sorted = mergeSort(unsorted, 0, unsorted.length - 1); //arr, 0, 9
console.log(sorted);
unsorted = [0, 3, 7, 5, 6, 4, 8, 2];
sorted = mergeSort(unsorted, 0, unsorted.length - 1); //arr, 0, 9
console.log(sorted);
